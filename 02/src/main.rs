...
fn main() {
    ...
    for (start, end) in &cleaned_ranges {
        ...
        for family in (2..=max_digits).step_by(2) {
            ...
            let min_base = if h == 1 { 1 } else { 10_i64.pow((h - 1) as u32) };
            ...
            // Sum using Gauss formula instead of looping. yes I actually googled how to do this and read this article https://letstalkscience.ca/educational-resources/backgrounders/gauss-summation
